    ...
    webix.ui({
        ...
        rows:[
          ...
          { 
            ...
            minHeight: 180,
            autowidth: true,
            url: "https://backend-randy-5zn7xh2gqq-et.a.run.app/data-barang-keluar",
            columns:[
                ...
                hapus:function(){
                    ...
                    if (item_id){
                        ...
                        ok:"Ya", cancel:"Tidak"
                            ...
                            webix.send("/barang-keluar", {"id": value.id, "action": "hapus"}, "POST")
                        })
                    }
                }
            },
        ...
        elements: [
            ...
            { 
                ...
                click: function(){
                    ...
                    webix.send("/barang-keluar", data, "POST");
                    form.hide();
                }
            }
        ],
